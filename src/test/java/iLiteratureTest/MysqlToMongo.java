...
@ContextConfiguration(locations = {"classpath:spring/applicationContext.xml", "classpath:spring/dao.xml"/*, "classpath:spring/service.xml"*/})
...
//    private static RiskBusinessDao riskBusinessDao = new RiskBusinessDaoImpl();
    ...
    public static void main(String[] args) throws SQLException {
        MysqlToMongo mysqlToMongo = new MysqlToMongo();
//        mysqlToMongo.dbToDb();
//        mysqlToMongo.tableToTable();
//        mysqlToMongo.table2table();

        //成功
//        mysqlToMongo.mysql2Mongo("authorupdate", "tempAuup");
...
//        MongoCollection collection = mongoConn.getCollection("authorupdate");
    ...
    private List<Document> saveTemp(List<Object> list){
        ...
        for(Object obj:list){
            String auupStr = JSON.toJSONString(obj);
